...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FinanceTransaction.amount'
        db.add_column('finance_entries_financetransaction', 'amount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FinanceTransaction.amount'
        db.delete_column('finance_entries_financetransaction', 'amount')
